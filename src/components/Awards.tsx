...
const Awards = () => {
    ...
    return (
        <section className="py-20 bg-gradient-to-r from-charcoal-900 to-charcoal-950 text-white">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold mb-4">Award-Winning Mentorship</h2>
                    <p className="text-charcoal-400">Recognized globally for our commitment to student success.</p>
                </div>
